        ...
        if ($result->num_rows === 1) {
            ...
            if ($password === $member['password']) {
                if ($member['status'] === 'Active') {
                    ...
                    $error = "Your account is currently inactive. Please contact the library administration.";
                }
            } else {
...
<head>
    ...
    <title>Member Login - LMS Portal</title>
    ...
    <style>
        /* * ==================================
         * ATTRACTIVE LOGIN STYLING (Consistent with Admin)
         * ==================================
         */
        ...
        * {
        ...
        /* Container for links at the bottom */
        .links-container {
            margin-top: 25px;
            display: flex;
...
<body>
    ...
    <div class="login-wrapper">
        ...
        <div class="login-panel-left">
            <i class="brand-icon fas fa-user-graduate"></i>
            <h2>LMS Member Portal</h2>
            <p>Welcome! Log in to manage your account, browse the catalog, and check your borrows.</p>
        </div>
            ...
            <div class="login-container">
                ...
                <form class="login-form" method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" id="member_uid" name="member_uid" placeholder="Student/Employee ID" required>
                    </div>
                    <div class="form-group">
